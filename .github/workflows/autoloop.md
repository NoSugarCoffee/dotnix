...
tools:
  ...
  github:
    mode: gh-proxy
    # repos: read flake.lock / pkgs sources. pull_requests: gh pr checks during
    # the CI fix loop. issues: read steering comments. actions: gh run view
    # --log to pull failing-check logs. No org/user/discussion access needed.
